...
def hget(handle: _SessionHandle, key: str | bytes, field: str | bytes, native: bool | None = None) -> Any: ...
def hmset(handle: _SessionHandle, key: str | bytes, mapping: dict[Any, Any]) -> bool: ...
def hmget(
    handle: _SessionHandle, key: str | bytes, fields: list[Any], native: bool | None = None
) -> list[Any]: ...
...
def hgetall(handle: _SessionHandle, key: str | bytes, native: bool | None = None) -> dict[Any, Any]: ...
def hkeys(handle: _SessionHandle, key: str | bytes, native: bool | None = None) -> list[Any]: ...
def hvals(handle: _SessionHandle, key: str | bytes, native: bool | None = None) -> list[Any]: ...
